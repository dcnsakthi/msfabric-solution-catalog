...
const WEB_ROOT = path.resolve(REPO_ROOT, 'src/msfabric_solution_catalog_web');
const catalogS_DIRS = [
  path.resolve(REPO_ROOT, 'src/msfabric_solution_catalog/msfabric_solution_catalog/catalogs/core'),
  path.resolve(REPO_ROOT, 'src/msfabric_solution_catalog/msfabric_solution_catalog/catalogs/community'),
];
...
function loadcatalogs(): catalogInfo[] {
  ...
  for (const dir of catalogS_DIRS) {
...
async function main(): Promise<void> {
  ...
  console.log(`  Found ${catalogs.length} catalogs with mermaid_diagram diagrams`);
