...
from msfabric_solution_catalog.utils import (
...
class TestResolveTokenCredential:
    ...
    @patch("msfabric_solution_catalog.utils.DefaultAzureCredential", create=True)
    ...
    @patch("msfabric_solution_catalog.utils._is_fabric_runtime", return_value=True)
    @patch("msfabric_solution_catalog.utils._generate_fabric_credential")
...
class TestWorkspaceManagerCredentialPassthrough:
    ...
    @patch("msfabric_solution_catalog.workspace_manager.resolve_token_credential")
    @patch("msfabric_solution_catalog.workspace_manager.FabricWorkspace")
    def test_credential_passed_to_fabric_workspace(self, mock_fw, mock_resolve):
        ...
        from msfabric_solution_catalog.workspace_manager import WorkspaceManager
