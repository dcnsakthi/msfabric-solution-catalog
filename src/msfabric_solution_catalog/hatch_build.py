...
class CustomBuildHook(BuildHookInterface):
    def initialize(self, version, build_data):
        ...
        if workload_dir.is_dir():
            build_data["force_include"][str(workload_dir)] = "msfabric_solution_catalog/ui/assets/workload"

        diagrams_dir = repo_assets / "diagrams"
        if diagrams_dir.is_dir():
            build_data["force_include"][str(diagrams_dir)] = "msfabric_solution_catalog/ui/assets/diagrams"
