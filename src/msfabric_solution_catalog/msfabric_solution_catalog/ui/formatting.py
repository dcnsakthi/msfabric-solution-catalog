"""Code formatting and syntax highlighting utilities for Fabric catalog."""
...
def syntax_highlight_python(code: str) -> str:
    ...
    Example:
        >>> syntax_highlight_python('catalog.install("demo")')
        '<span style="color: #096bbc">catalog</span>...'
    """
...
def render_copyable_code(code: str, include_syntax_highlighting: bool = True) -> str:
    """Render a code snippet in catalog-install style with copy button.
    ...
    Example:
        >>> html = render_copyable_code('catalog.install("demo")')
        >>> 'catalog-install' in html
        True
    """
