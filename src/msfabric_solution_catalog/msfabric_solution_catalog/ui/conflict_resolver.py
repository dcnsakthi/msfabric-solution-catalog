...
class ConflictResolver:
    ...
    def __init__(
        ...
        Args:
            ...
            catalog_id: Numeric catalog ID
            logical_id: Logical catalog ID (e.g., "analytics-lab")
        """
        self.workspace_manager = workspace_manager
        self.catalog_id = catalog_id
        self.logical_id = logical_id
        self.system_prefix = _set_item_prefix(catalog_id, logical_id)
...
class ConflictUI:
    ...
    def render_conflict_html(
        ...
        Args:
            ...
            instance_name: Name of catalog instance (e.g., "catalog")
            catalog_name: Logical ID of catalog
        ...
        update_existing_snippet = f"{instance_name}.install(\"{catalog_name}\"{ws_arg}, update_existing=True)"
        autoprefix_snippet = f"{instance_name}.install(\"{catalog_name}\"{ws_arg}, auto_prefix_on_conflict=True)"
        custom_prefix_snippet = f"{instance_name}.install(\"{catalog_name}\"{ws_arg}, item_prefix=\"<your_prefix>\")"
