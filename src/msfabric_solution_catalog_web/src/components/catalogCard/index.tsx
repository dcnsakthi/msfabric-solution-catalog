  ...
  return (
    <div style={{ padding: '36px 20px 20px', display: 'flex', flexDirection: 'column' as const, flexGrow: 1, backgroundColor: isDark ? '#1a1a1a' : '#f8f8f8' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap' as const, gap: '6px', marginBottom: '10px' }}>
        {scenario.core && (
          <Tooltip content="Microsoft-sponsored catalog" relationship="description" withArrow>
            <span style={{
              display: 'inline-flex',
              alignItems: 'center',
...
export default function catalogCard({ scenario, isDark, onExpandDiagram, className, style }: catalogCardProps) {
  return (
