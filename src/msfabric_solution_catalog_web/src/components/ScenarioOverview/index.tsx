...
import { workloadColors } from '@components/catalogCard';
...
export default function ScenarioOverview({ scenario, mermaid_diagram }: { scenario: ScenarioCard; mermaid_diagram?: string }) {
  ...
  const installCode = `import msfabric_solution_catalog as catalog\n\n# Install this scenario\ncatalog.install("${scenario.slug}")`;
  ...
  return (
    <div style={{
      ...
      <div>
        ...
        >
          🚀 New to catalog? Read the Getting Started guide →
        </a>
        <div style={{
          borderRadius: '6px',
          overflow: 'hidden',
