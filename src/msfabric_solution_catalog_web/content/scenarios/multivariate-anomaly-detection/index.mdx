...
This catalog deploys a comprehensive solution accelerator for performing advanced anomaly detection using data from multiple variables with Microsoft Fabric's real-time intelligence capabilities. 
...
### Step 1: Install the **Multivariate Anomaly Detection** catalog
