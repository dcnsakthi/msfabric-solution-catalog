...
Each subfolder is a documentation page for a catalog, served at `/msfabric_solution_catalog/<logical_id>`.
...
Folder name must match the catalog's `logical_id`. Folders starting with `_` are ignored.

## Frontmatter

```yaml
---
title: My catalog          # required
