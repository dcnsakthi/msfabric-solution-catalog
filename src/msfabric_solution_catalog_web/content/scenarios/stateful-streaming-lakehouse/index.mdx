...
This catalog is designed as a hands-on workshop (Module 2 of the Stateful Streaming Lakehouse series). It covers two progression levels:
...
🛡️ **Why normalize column names as early as possible?** Source systems are unpredictable — column names may arrive as `PascalCase`, `camelCase`, contain spaces, or even contain special characters that make data engineering unnecessarily tedious. Normalizing early means every downstream consumer gets a consistent contract from day one.
