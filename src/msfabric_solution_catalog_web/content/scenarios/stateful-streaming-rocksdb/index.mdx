...
This catalog deploys a stateful stream processing demo using Spark Structured Streaming with RocksDB hosted on OneLake into your Microsoft Fabric workspace.
...
After installing the catalog, visit the [companion website](https://heartbeatspark.z9.web.core.windows.net) to create heartbeat producers and consumers right in your browser.
