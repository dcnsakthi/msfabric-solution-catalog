...
This catalog deploys a comprehensive solution for power utilities to monitor and optimize electrical grids using Advanced Metering Infrastructure (AMI) data with Microsoft Fabric's real-time intelligence capabilities.
...
### Step 1: Install the **Grid Intelligence** catalog
...
When you run the post-deployment notebook, all event simulator notebooks will be started automatically. You may skip to the [Viewing Reports and Dashboards](#viewing-reports-and-dashboards) section.

By default, these simulations will run for 2 hours and stop. To restart the simulations, please follow these steps:
...
5. New storm fronts will continue to pass through the service area while the simulation is in progress.
